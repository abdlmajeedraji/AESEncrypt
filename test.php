...
<head>
  ...
  <meta name="author" content="Raji Abdulmajeed">
  <!--
...
document.getElementById("0").innerHTML = myString;
document.getElementById("1").innerHTML = encrypted;
document.getElementById("2").innerHTML = decrypted;
document.getElementById("3").innerHTML = decrypted.toString(CryptoJS.enc.Utf8);
